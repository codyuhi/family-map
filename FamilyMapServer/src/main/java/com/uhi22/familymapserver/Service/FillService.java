...
public class FillService extends Service {
     ...
     *                          }
     *
     * @throws com.uhi22.familymapserver.Errors.InvalidUsernameError      Throws an invalid username/password error if the provided username/password could not be found
     * @throws com.uhi22.familymapserver.Errors.InvalidGenerationsError   Throws an invalid generations error if the number of generations requested is outside of an acceptable range
     * @throws com.uhi22.familymapserver.Errors.InternalServerError       Throws an internal server error if the server has problems executing the operation
     *
