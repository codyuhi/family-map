...
import Errors.RequestPropertyInvalidValue;
import Errors.RequestPropertyMissingValue;
...
public class LoginService {
     ...
     *                  }
     *
     * @throws Errors.RequestPropertyMissingValue   Throws missing value error if a value is missing in input
     * @throws Errors.RequestPropertyInvalidValue   Throws invalid value error if a value is invalid
     * @throws Errors.InternalServerError           Throws an internal server error if something went
